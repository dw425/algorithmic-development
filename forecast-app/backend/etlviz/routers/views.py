...
from etlviz.models.database import (
    Upload,
...
def get_anomalies(
    ...
    from etlviz.engines.vectors.feature_extractor import extract_session_features
    features = extract_session_features(tier_data)

    from etlviz.engines.anomaly_detector import AnomalyDetector
...
def get_effort_estimate(
    ...
    _check_upload(db, upload_id)
    from etlviz.engines.data_populator import reconstruct_vector_results
    ...
    from etlviz.engines.effort_estimator import MigrationEffortEstimator
...
def transpile_expressions(
    ...
    _check_upload(db, upload_id)
    from etlviz.models.database import ExpressionRecord as ER
    ...
    from etlviz.engines.transpiler import ExpressionTranspiler
