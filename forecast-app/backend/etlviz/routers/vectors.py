...
from etlviz.engines.vectors.orchestrator import VectorOrchestrator
...
async def analyze_vectors(
    ...
    if upload_id:
        ...
        if upload:
            ...
            from etlviz.engines.data_populator import populate_vector_tables
            try:
...
from etlviz.config import settings as _settings
...
async def analyze_vectors_background(
    ...
    def _run():
        from etlviz.models.database import SessionLocal
...
async def what_if_simulation(
    ...
    try:
        from etlviz.engines.vectors.v9_wave_function import WaveFunctionVector
        from etlviz.engines.vectors.feature_extractor import (
